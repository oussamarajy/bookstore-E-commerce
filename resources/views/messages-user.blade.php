            ...
            <table class="table bg-white rounded shadow-sm  table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <form action="{{ route('message-user.delete', $msg->id) }}" method="post">
                            @csrf
                            @method('delete')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
             ...
             <form action="{{ route('rep.user') }}" method="post">
                @csrf
...
<script>
    $(document).ready(function($){
        ...
        $('.btnshow').click(function(){
            ...
            $('#contenuMsg').empty();
            $.ajax({
                url:  "show-message-user/"+id,
                type: "GET",
                dataType: "JSON",
                success: function(response){

                    $('#contenuMsg').append('<li><b class="text-primary">De :</b> '+response[0]['nom']+' : Admin</li>');
