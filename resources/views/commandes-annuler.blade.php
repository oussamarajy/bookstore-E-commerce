            ...
            <table class="table bg-white rounded shadow-sm  table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $cmd->totalr }}DH</td>
                        <td class="text-danger fst-italic">annulée</td>
                        <td class=" position-relative d-flex flex-lg-row"><a href="{{ route('commande.show', $cmd->id) }}" class="btn btn-warning me-2"><i class="fas fa-eye"></i></a>
                            @if (!$cmd->deja_vu)
                            ...
                            <form action="{{ route('commande.delete', $cmd->id) }}" method="post">
                                @csrf
                                @method('delete')
                                <input type="hidden" value="pagecannuler" name="page">
